...
public:
	GeneralTestFixture()
	{
        ...
        if (timeConsumingTestSuites.size() == 0)
        {
            timeConsumingTestSuites.push_back("stStaticCall");
            timeConsumingTestSuites.push_back("stSStoreTest");
            timeConsumingTestSuites.push_back("stQuadraticComplexityTest");
        }
